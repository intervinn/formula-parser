  ...
  return (
    <div className="flex flex-col justify-between min-h-screen dark:bg-slate-800">
      <div className="flex flex-col justify-center items-center pt-32">
        <h1 className="text-2xl font-mono font-bold dark:text-white">Formula Parser</h1>
        <h1 className="text-2xl font-mono dark:text-white">{formula}</h1>
      ...
      <div className="bg-slate-300 w-96 h-fit pb-11 px-40 shadow-2xl flex flex-col justify-start items-center">
        <div className="w-36 text-center font-mono">Molecular Mass: {molecularMass}</div>
        {(() => {
